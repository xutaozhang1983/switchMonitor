...
function isActive(r: RouteRecordRaw) {
  return r.path === route.path
}
function activeStyle(tag: RouteRecordRaw) {
...
function refreshSelectedTag(view: Element) {
  proxy.$tab.refreshPage(view);
  if (route.meta.link) {
    useTagsViewStore().delIframeView(route);
  }
}
function closeSelectedTag(view: Element) {
